...
const About = () => {
    return (
        <div className="h-[76vh] w-2/4 mx-auto flex flex-col justify-around 
        items-center p-4 m-4 font-fira shadow-lg bg-gray-200 rounded">
            <h1 className="font-bold text-2xl  text-red-600">Sobre o Projeto</h1>
            <p className="text-center text-lg">Dolor incididunt exercitation reprehenderit sit nisi id proident sunt consequat velit ex velit Lorem ipsum.
